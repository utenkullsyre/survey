...
# urluser = 'http://127.0.0.1:5000/api/user'
#
...
#     return r.json()
#
# def new_user(url, email, password):
#     r = requests.post(url, json={'email': '{}'.format(email), 'password': '{}'.format(password)})
#     return(r.json())

r = requests.get("http://127.0.0.1:5000/api/category")
# print(r.json())
# nybruker = new_user(urluser, 'tull@helvete.no', 'helvete')
# print(nybruker)

# print(get_category(urluser))
